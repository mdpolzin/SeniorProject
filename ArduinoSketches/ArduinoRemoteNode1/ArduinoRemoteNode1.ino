...
/* ButtonPressed Event */
char event3_name[] = "Button Pressed";
char event3_desc[] = "The button has been pressed";
const int event3_id = 3;
uint8_t event3_trig = 0;
...
void loop()
{
  ...
  // if it is, throw the proper event
  ...
  if (xbee.getResponse().getApiId() == RX_64_RESPONSE)
  {
    ...
    switch(data[0])
    {
      ...
      case MISMATCH_BYTE:
        ...
        //ButtonPressed Event information
